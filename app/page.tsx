...
export default function LandingPage() {
  ...
  // Add parallax effect to hero section based on scroll
  const heroOpacity = Math.max(1 - scrollY / 500, 0.5) // Fade effect
  const heroTransform = `translateY(${scrollY * 0.5}px)` // Parallax effect
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <AttractionCard 
                ...
                icon={<SunIcon className="h-6 w-6 md:h-8 md:w-8" />}
              ...
              <AttractionCard 
                ...
                icon={<MountainIcon className="h-6 w-6 md:h-8 md:w-8" />}
              ...
              <AttractionCard 
                ...
                icon={<WavesIcon className="h-6 w-6 md:h-8 md:w-8" />}
