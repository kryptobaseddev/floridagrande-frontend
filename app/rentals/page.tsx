          ...
          <Card>
            <CardContent className="p-6">
              <ul className="list-disc list-inside space-y-4">
                ...
                <li>Daily, weekly, and monthly rates available</li>
                <li>Access to all resort amenities included with your stay</li>
                <li>Pet-friendly (breed restrictions may apply)</li>
                <li>Minimum stay: 3 nights</li>
                <li>Check-in time: 2:00 PM, Check-out time: 11:00 AM</li>
                <li>Cancellation policy: Full refund if cancelled 7 days before arrival</li>
              </ul>
            </CardContent>
          </Card>
        </section>
